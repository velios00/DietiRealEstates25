...
export class OfferController {
    static async createOffer(req, res, next) {
        try {
            ...
            const createdOffer = await OfferService.createOffer(Offer, RealEstate, dto, req.userId)
    ...
    static async getOffersByRealEstateId(req, res, next) {
        try {
            ...
            const offers = await OfferService.getOffersByRealEstateId(Offer, idRealEstate);
